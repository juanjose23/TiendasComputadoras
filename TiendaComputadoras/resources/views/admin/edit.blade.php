...
@section('submodulo', 'Actualizar datos personales')
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="inss" name="inss" placeholder="Escribe el número inss"
                        ...
                        value="{{ old('inss', $empleados->codigo_inss) }}" hidden>
                    @error('inss')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-12">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-2">
                    <a href="{{ route('perfil') }}" class="btn btn-danger mb-2 me-md-2">Cancelar</a>
