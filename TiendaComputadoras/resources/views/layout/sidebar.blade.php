        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                ...
                <ul id="inventario" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class='sidebar-link text-white-50'
                            href='/pages-projects'>Proveedores</a></li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-clients'>Stock</a>
                    </li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50'
                            href='/pages-orders'>Movimientos</a></li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-pricing'>Gestión de
                            ubicaciones</a></li>
                </ul>
            </li>
            <li class="sidebar-item">
                ...
                <ul id="compras" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-projects'>Solicitudes
                        </a></li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-clients'>Cotizaciones
                        </a></li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-orders'>Ordenes</a>
                    </li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-pricing'>Compras </a>
                    </li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50'
                            href='/pages-chat'>Devoluciones</a></li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50'
                            href='/pages-blank'>Recepciones</a></li>
                </ul>
            </li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="negocio" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class='sidebar-link text-white-50'
                            href='{{ route('cargos.index') }}'>Cargos</a></li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50'
                            href='{{ route('colaboradores.index') }}'>Colaboradores</a></li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50'
                            href='{{ route('asignaciones.index') }}'>Asignacion de cargos</a></li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50'
                            href='{{ route('salarios.index') }}'>Salarios </a></li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="Ventas" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-projects'>Pedidos</a>
                    </li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-clients'>Cotizaciones
                        </a></li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-orders'>Ventas</a>
                    </li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-pricing'>Entregas
                        </a></li>
                </ul>
            </li>
            <li class="sidebar-item">
                ...
                <ul id="caja" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-projects'>Caja </a>
                    </li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-projects'>Apertura
                        </a></li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-clients'>Arqueo </a>
                    </li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-orders'>Cierre</a>
                    </li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50'
                            href='/pages-blank'>Configuraciones</a></li>
                </ul>
            </li>
            <li class="sidebar-item">
                ...
                <ul id="usuarios" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-projects'>Roles</a>
                    </li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-clients'>Usuarios</a>
                    </li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50'
                            href='/pages-orders'>Privilegios</a></li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-pricing'>Permisos</a>
                    </li>
                    <li class="sidebar-item"><a class='sidebar-link text-white-50' href='/pages-chat'>Conexiones</a>
                    </li>
                </ul>
            </li>
        </ul>
