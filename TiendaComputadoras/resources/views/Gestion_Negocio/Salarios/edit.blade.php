...
@section('submodulo', 'Actualizar salarios')
@section('content')
    <form action="{{ route('salarios.update',$empleados->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-12">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-2">
                    <a href="{{ route('salarios.index') }}" class="btn btn-danger mb-2 me-md-2">Cancelar</a>
