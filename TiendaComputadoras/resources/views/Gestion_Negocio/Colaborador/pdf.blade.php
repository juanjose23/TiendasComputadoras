...
<style>
    ...
    *,
    ...
    .form-select:focus {
        ...
        box-shadow: 0 0 0 .2rem rgba(59,125,221,.25);outline:0}.form-select[multiple],.form-select[size]:not([size="1"]) {
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="mb-1"><span data-feather="calendar" class="feather-sm me-1"></span><a href="#">Fecha de nacimiento: </a></li>
                            <li class="mb-1"><span data-feather="credit-card" class="feather-sm me-1"></span><a href="#">Tipo de identificación: </a></li>
                            <li class="mb-1"><span data-feather="user" class="feather-sm me-1"></span><a href="#">Identificación:</a></li>
                            <li class="mb-1"><span data-feather="mail" class="feather-sm me-1"></span><a href="#">Correo: </a></li>
                            <li class="mb-1"><span data-feather="phone" class="feather-sm me-1"></span><i class="bi bi-phone"></i> <a href="#">Teléfono: </a></li>
                        </ul>
                    </div>
                    <hr class="my-0" />
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            ...
                            <li class="mb-1"><span data-feather="briefcase" class="feather-sm me-1"></span> Works
                                at
                                <a href="#">GitHub</a>
                            </li>
